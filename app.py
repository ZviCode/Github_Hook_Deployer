...
def health_check_event(data):
    ...
    if not list_repo_check_run or service_name in list_repo_check_run:
        ...
        if not list_branches or head_branch in list_branches:
...
def push_event(data):
    service_name = data['repository']['name']
    if not list_repo_push or service_name in list_repo_push:
